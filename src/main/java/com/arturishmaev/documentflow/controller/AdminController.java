...
public class AdminController {
    ...
    public AdminController(GeneralService<EmployeeEntity> employeeGeneralService, Mapper mapper
            , GeneralService<RoleEntity> roleService, GeneralService<DepartmentEntity> departmentGeneralService
            , GeneralService<OrganizationEntity> organizationGeneralService, PasswordEncoder passwordEncoder) {
